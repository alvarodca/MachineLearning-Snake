...
def move_ml(game):
    ...
    game_data = [
        head_x, head_y, food_x, food_y, game.score,
    ...
    prediction = weka.predict("./nn_iter1.model", game_data, "./training_processed_keyboard.arff")
...
#def move_tutorial_1(game):
    ...
    #data = normalize_data(data, game.min_vals, game.max_vals)

    #print("Data before prediction:", data)
    # Prepare the data and pass it to the model
    #prediction = weka.predict("./best_model_iter1.model", data, "./training_processed_keyboard.arff")
...
def print_line_data(game):
    ...
    arff_file = "training6_keyboard.arff"
    header = """@RELATION snake_game
    ...
    """game_data = [
        ...
        dist_body_x4, dist_body_y4,tail_x, tail_y, horizontal_weight, vertical_weight, length, 0,game.direction  
    ]"""
